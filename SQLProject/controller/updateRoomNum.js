let updateRoomNum = function (req, res, next) {
   ...
   // let queryString = "UPDATE shelter SET availableroom =  availableroom + " + req.body.availableroom + " WHERE site_id = "+"'" + req.body.siteid + "'";
